...
import { initReport } from '~/types/report'
import { getMonthFinalDate, getMonthFirstDate } from '../Date'
import { insertReport } from '../Firebase/firestore'
...
export async function insertFakeReport() {
  const first = getMonthFirstDate()
  const final = getMonthFinalDate()
